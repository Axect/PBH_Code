...
plt.axis([32, 38, 0.0000, 0.001])
plt.legend(fontsize=12)
plt.savefig("../PBH_Fig/lH_Mt_170_8_.png", dpi=600)
...
plt.savefig("../PBH_Fig/ga_Mt_170_88.png", dpi=600)
...
plt.savefig("../PBH_Fig/G_Mt_170_88.png", dpi=600)
...
plt.legend(fontsize=12)
plt.axis([0,25, -1*10**(-7), 1*10**(-5)])
plt.savefig("../PBH_Fig/V_Mt_170_8_.png", dpi=600)